...
df = pd.read_parquet('datasets/yolov9-segmented-objects-dataset.parquet')
...
best_model_filename = f'datasets/hierarchical-model-weights/weights/best_model_alpha_yolov9_{args.alpha:.2f}.pth'
last_model_filename = f'datasets/hierarchical-model-weights/weights/last_model_alpha_yolov9_{args.alpha:.2f}.pth'

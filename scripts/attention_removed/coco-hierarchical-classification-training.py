...
log_directory = '/mnt/RAID/projects/FjordVision/models/ablations/attention_removed/logs-coco/'
weights_directory = '/mnt/RAID/projects/FjordVision/models/ablations/attention_removed/weights-coco/'

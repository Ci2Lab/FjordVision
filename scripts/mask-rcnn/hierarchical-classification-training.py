...
log_filename = f'logs/model_alpha_rcnn{args.alpha:.2f}.csv'
best_model_filename = f'datasets/MaskRCNN-weights/hierarchical-weights/best_model_alpha_{args.alpha:.2f}.pth'
last_model_filename = f'datasets/MaskRCNN-weights/hierarchical-weights/last_model_alpha_{args.alpha:.2f}.pth'
        ...
        with torch.no_grad():
            for images, conf, pred_species, species_index, genus_index, class_index, binary_index in val_loader:
                ...
                if isinstance(loss, torch.Tensor):
                    ...
                    print(f"Validation Loss is not a tensor. Loss: {loss}")
